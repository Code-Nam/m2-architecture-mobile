...
mixin _$Unit {
 ...
 String get id; String get title; List<Lesson> get lessons;
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Unit&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.title, _this.title) || other.title == _this.title)&&const DeepCollectionEquality().equals(other.lessons, _this.lessons));
}
...
String toString() {
  final _this = this as Unit;
  return 'Unit(id: ${_this.id}, title: ${_this.title}, lessons: ${_this.lessons})';
}
...
@useResult
$Res call({
 String id, String title, List<Lesson> lessons
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  List<Lesson> lessons)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Unit() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  List<Lesson> lessons)  $default,) {final _that = this;
switch (_that) {
case _Unit():
return $default(_that.id,_that.title,_that.lessons);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  List<Lesson> lessons)?  $default,) {final _that = this;
switch (_that) {
case _Unit() when $default != null:
return $default(_that.id,_that.title,_that.lessons);case _:
  return null;
...
class _Unit implements Unit {
  const _Unit({required this.id, required this.title, required  List<Lesson> lessons}): _lessons = lessons;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _Unit&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other.lessons, _lessons));
}
...
@override
String toString() {
    return 'Unit(id: $id, title: $title, lessons: $lessons)';
}
