...
| `assets/lessons/unit_01_lire_les_tuiles.json` | file (no marker); drill block added to lesson 1, interactive block added to lesson 2, lesson 2 quiz feedback no longer points at the green circle, unit renamed « Familles et suites » (2026-09-25, content exception) | 2026-09-18 | |
...
| `assets/lessons/unit_06_le_score.json` | file (no marker); 2 lessons drafted 2026-09-25 (content exception) | 2026-09-18 | |
...
| `lib/settings/settings_repository.dart` | dartdoc | 2026-09-25 | Docs are time-consuming for the author; code stays author-written. |
| `lib/scanner/scan_history_repository.dart` | dartdoc | 2026-09-25 | Docs are time-consuming for the author; code stays author-written. |
| `lib/yaku/yaku_cache_source.dart` | dartdoc | 2026-09-25 | Docs are time-consuming for the author; code stays author-written. |
| `lib/yaku/cached_yaku_repository.dart` | dartdoc | 2026-09-25 | Docs are time-consuming for the author; code stays author-written. |
| `lib/settings/isar_settings_repository.dart` | dartdoc | 2026-09-25 | Docs are time-consuming for the author; code stays author-written. |
| `lib/scanner/isar_scan_history_repository.dart` | dartdoc | 2026-09-25 | Docs are time-consuming for the author; code stays author-written. |
...
| `test/fakes/fake_settings_repository.dart` | file | 2026-09-25 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/fakes/fake_scan_history_repository.dart` | file | 2026-09-25 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/fakes/fake_yaku_cache_source.dart` | file | 2026-09-25 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/yaku/cached_yaku_repository_test.dart` | file | 2026-09-25 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/settings/settings_providers_test.dart` | file | 2026-09-25 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/settings/settings_screen_test.dart` | file | 2026-09-25 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/scanner/scan_history_screen_test.dart` | file | 2026-09-25 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
...
| `test/fakes/fake_auth_repository.dart` | file | 2026-09-23 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/fakes/fake_profile_repository.dart` | file | 2026-09-23 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/auth/auth_failure_test.dart` | file | 2026-09-23 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/auth/auth_providers_test.dart` | file | 2026-09-23 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/auth/welcome_screen_test.dart` | file | 2026-09-23 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/auth/login_screen_test.dart` | file | 2026-09-23 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/onboarding/level_screen_test.dart` | file | 2026-09-23 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/onboarding/goal_screen_test.dart` | file | 2026-09-23 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/profile/profile_providers_test.dart` | file | 2026-09-23 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/profile/profile_screen_test.dart` | file | 2026-09-23 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
| `test/app/router_test.dart` | file | 2026-09-23 | Test scaffolding is tedious and teaches no Flutter concept; the code under test is author-written. |
