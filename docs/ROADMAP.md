...
after grading). Known leftovers: `lib/main.dart:27` startup message still
says « --dart-define=YAKU_BASE_URL … (README, Getting started) »; Google
...
| Grading fixes | README self-hosted API rationale, lesson verdict moved into the notifier, gallery pick in the scanner, convention findings cleared | plan 2026-09-25: [docs/plans/2026-09-25-grading-fixes.md](plans/2026-09-25-grading-fixes.md) + `.tasks.json`; Tasks 0–3 done (README + checker; verdict in the notifier; gallery pick; `app.dart` → `tenpai_app.dart`, conventions 0 findings), Task 4 done (tests, suite 388), Task 5 in progress (device pass) |
