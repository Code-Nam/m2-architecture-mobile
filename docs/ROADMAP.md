...
| Grading fixes | README self-hosted API rationale, lesson verdict moved into the notifier, gallery pick in the scanner, convention findings cleared | plan 2026-09-25: [docs/plans/2026-09-25-grading-fixes.md](plans/2026-09-25-grading-fixes.md) + `.tasks.json`; Task 0 done (README + checker, 7 → 1 finding), Tasks 1–5 `pending` |
